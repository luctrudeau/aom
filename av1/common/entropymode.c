...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(24812), AOM_ICDF(24975), AOM_ICDF(25645), AOM_ICDF(25952),
        AOM_ICDF(26109), AOM_ICDF(26274), AOM_ICDF(26448), AOM_ICDF(26679),
        AOM_ICDF(26839), AOM_ICDF(27533), AOM_ICDF(27971), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10756), AOM_ICDF(15329), AOM_ICDF(17536), AOM_ICDF(17905),
        AOM_ICDF(18071), AOM_ICDF(18874), AOM_ICDF(18957), AOM_ICDF(19049),
        AOM_ICDF(19470), AOM_ICDF(20249), AOM_ICDF(24812), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12792), AOM_ICDF(12848), AOM_ICDF(19327), AOM_ICDF(20492),
        AOM_ICDF(20616), AOM_ICDF(20687), AOM_ICDF(21040), AOM_ICDF(21502),
        AOM_ICDF(21565), AOM_ICDF(22903), AOM_ICDF(25082), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15928), AOM_ICDF(16117), AOM_ICDF(16806), AOM_ICDF(21476),
        AOM_ICDF(21669), AOM_ICDF(21933), AOM_ICDF(22364), AOM_ICDF(23239),
        AOM_ICDF(23919), AOM_ICDF(25307), AOM_ICDF(25761), AOM_ICDF(32768), 0 },
      { AOM_ICDF(16145), AOM_ICDF(16255), AOM_ICDF(16932), AOM_ICDF(17440),
        AOM_ICDF(23640), AOM_ICDF(24691), AOM_ICDF(25542), AOM_ICDF(25768),
        AOM_ICDF(26116), AOM_ICDF(26860), AOM_ICDF(27362), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13016), AOM_ICDF(13564), AOM_ICDF(14610), AOM_ICDF(15047),
        AOM_ICDF(16392), AOM_ICDF(24526), AOM_ICDF(24741), AOM_ICDF(24925),
        AOM_ICDF(25188), AOM_ICDF(25801), AOM_ICDF(25866), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15936), AOM_ICDF(16004), AOM_ICDF(17229), AOM_ICDF(18026),
        AOM_ICDF(19170), AOM_ICDF(19371), AOM_ICDF(23773), AOM_ICDF(23948),
        AOM_ICDF(24365), AOM_ICDF(25235), AOM_ICDF(25524), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15569), AOM_ICDF(15651), AOM_ICDF(16420), AOM_ICDF(17679),
        AOM_ICDF(17849), AOM_ICDF(17972), AOM_ICDF(18204), AOM_ICDF(22362),
        AOM_ICDF(22526), AOM_ICDF(24621), AOM_ICDF(25066), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14729), AOM_ICDF(15230), AOM_ICDF(15907), AOM_ICDF(17310),
        AOM_ICDF(17545), AOM_ICDF(17939), AOM_ICDF(18168), AOM_ICDF(18802),
        AOM_ICDF(22509), AOM_ICDF(23582), AOM_ICDF(24568), AOM_ICDF(32768), 0 },
      { AOM_ICDF(18617), AOM_ICDF(18832), AOM_ICDF(19446), AOM_ICDF(19745),
        AOM_ICDF(20038), AOM_ICDF(20185), AOM_ICDF(20438), AOM_ICDF(20768),
        AOM_ICDF(21007), AOM_ICDF(22526), AOM_ICDF(24852), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15488), AOM_ICDF(16392), AOM_ICDF(18937), AOM_ICDF(19384),
        AOM_ICDF(19525), AOM_ICDF(19765), AOM_ICDF(19899), AOM_ICDF(20158),
        AOM_ICDF(20342), AOM_ICDF(21137), AOM_ICDF(25383), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(11669), AOM_ICDF(15248), AOM_ICDF(21385), AOM_ICDF(22327),
  AOM_ICDF(24612), AOM_ICDF(26828), AOM_ICDF(27569), AOM_ICDF(28378),
  AOM_ICDF(28794), AOM_ICDF(29428), AOM_ICDF(29713), AOM_ICDF(30771),
  AOM_ICDF(31813), AOM_ICDF(32245), AOM_ICDF(32667), AOM_ICDF(32768),
};

static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(5180), AOM_ICDF(9915), AOM_ICDF(13926), AOM_ICDF(16248),
  AOM_ICDF(17523), AOM_ICDF(19664), AOM_ICDF(20434), AOM_ICDF(22494),
  AOM_ICDF(23477), AOM_ICDF(25756), AOM_ICDF(26323), AOM_ICDF(28540),
  AOM_ICDF(28944), AOM_ICDF(30089), AOM_ICDF(31509), AOM_ICDF(32768),
};
#endif
