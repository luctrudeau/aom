...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(24867), AOM_ICDF(25037), AOM_ICDF(25587), AOM_ICDF(25829),
        AOM_ICDF(25988), AOM_ICDF(26149), AOM_ICDF(26323), AOM_ICDF(26568),
        AOM_ICDF(26730), AOM_ICDF(27460), AOM_ICDF(27928), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12186), AOM_ICDF(17312), AOM_ICDF(18075), AOM_ICDF(18307),
        AOM_ICDF(18464), AOM_ICDF(19077), AOM_ICDF(19160), AOM_ICDF(19244),
        AOM_ICDF(19664), AOM_ICDF(20475), AOM_ICDF(24842), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13892), AOM_ICDF(13946), AOM_ICDF(20318), AOM_ICDF(20692),
        AOM_ICDF(20807), AOM_ICDF(20875), AOM_ICDF(21219), AOM_ICDF(21653),
        AOM_ICDF(21713), AOM_ICDF(22779), AOM_ICDF(25179), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15964), AOM_ICDF(16155), AOM_ICDF(16599), AOM_ICDF(21714),
        AOM_ICDF(21908), AOM_ICDF(22151), AOM_ICDF(22471), AOM_ICDF(23386),
        AOM_ICDF(24116), AOM_ICDF(25586), AOM_ICDF(26023), AOM_ICDF(32768), 0 },
      { AOM_ICDF(16152), AOM_ICDF(16265), AOM_ICDF(16813), AOM_ICDF(17179),
        AOM_ICDF(23979), AOM_ICDF(24999), AOM_ICDF(25936), AOM_ICDF(26150),
        AOM_ICDF(26438), AOM_ICDF(27223), AOM_ICDF(27640), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13248), AOM_ICDF(13882), AOM_ICDF(14633), AOM_ICDF(14953),
        AOM_ICDF(16284), AOM_ICDF(24716), AOM_ICDF(24930), AOM_ICDF(25090),
        AOM_ICDF(25328), AOM_ICDF(26007), AOM_ICDF(26087), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15901), AOM_ICDF(15973), AOM_ICDF(17110), AOM_ICDF(17571),
        AOM_ICDF(18650), AOM_ICDF(18842), AOM_ICDF(24171), AOM_ICDF(24343),
        AOM_ICDF(24617), AOM_ICDF(25511), AOM_ICDF(25776), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15614), AOM_ICDF(15697), AOM_ICDF(16346), AOM_ICDF(17223),
        AOM_ICDF(17383), AOM_ICDF(17499), AOM_ICDF(17714), AOM_ICDF(22658),
        AOM_ICDF(22811), AOM_ICDF(24757), AOM_ICDF(25157), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14839), AOM_ICDF(15331), AOM_ICDF(15741), AOM_ICDF(16883),
        AOM_ICDF(17100), AOM_ICDF(17437), AOM_ICDF(17623), AOM_ICDF(18085),
        AOM_ICDF(22558), AOM_ICDF(23736), AOM_ICDF(24665), AOM_ICDF(32768), 0 },
      { AOM_ICDF(18838), AOM_ICDF(19055), AOM_ICDF(19553), AOM_ICDF(19799),
        AOM_ICDF(20064), AOM_ICDF(20239), AOM_ICDF(20496), AOM_ICDF(20833),
        AOM_ICDF(21071), AOM_ICDF(22724), AOM_ICDF(24737), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15112), AOM_ICDF(16037), AOM_ICDF(18068), AOM_ICDF(18364),
        AOM_ICDF(18505), AOM_ICDF(18709), AOM_ICDF(18844), AOM_ICDF(19086),
        AOM_ICDF(19265), AOM_ICDF(20097), AOM_ICDF(25603), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(14059), AOM_ICDF(16178), AOM_ICDF(22111), AOM_ICDF(22627),
  AOM_ICDF(24868), AOM_ICDF(27022), AOM_ICDF(27699), AOM_ICDF(28355),
  AOM_ICDF(28732), AOM_ICDF(29443), AOM_ICDF(29711), AOM_ICDF(30800),
  AOM_ICDF(31870), AOM_ICDF(32270), AOM_ICDF(32670), AOM_ICDF(32768),
};

static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(5647), AOM_ICDF(10289), AOM_ICDF(14296), AOM_ICDF(16451),
  AOM_ICDF(17670), AOM_ICDF(19725), AOM_ICDF(20458), AOM_ICDF(22606),
  AOM_ICDF(23549), AOM_ICDF(25907), AOM_ICDF(26446), AOM_ICDF(28647),
  AOM_ICDF(29040), AOM_ICDF(30197), AOM_ICDF(31538), AOM_ICDF(32768),
};
#endif
