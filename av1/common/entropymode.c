...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(22220), AOM_ICDF(22357), AOM_ICDF(23865), AOM_ICDF(25031),
        AOM_ICDF(25210), AOM_ICDF(25428), AOM_ICDF(25629), AOM_ICDF(25865),
        AOM_ICDF(26060), AOM_ICDF(26631), AOM_ICDF(27027), AOM_ICDF(32768), 0 },
      { AOM_ICDF(2446), AOM_ICDF(4718), AOM_ICDF(19026), AOM_ICDF(20362),
        AOM_ICDF(20619), AOM_ICDF(22178), AOM_ICDF(22299), AOM_ICDF(22589),
        AOM_ICDF(22965), AOM_ICDF(23516), AOM_ICDF(26538), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4239), AOM_ICDF(4327), AOM_ICDF(8511), AOM_ICDF(21541),
        AOM_ICDF(21740), AOM_ICDF(21858), AOM_ICDF(22202), AOM_ICDF(22670),
        AOM_ICDF(22809), AOM_ICDF(24626), AOM_ICDF(25758), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14441), AOM_ICDF(14604), AOM_ICDF(16177), AOM_ICDF(19293),
        AOM_ICDF(19504), AOM_ICDF(19839), AOM_ICDF(20853), AOM_ICDF(21834),
        AOM_ICDF(22285), AOM_ICDF(23431), AOM_ICDF(23887), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14574), AOM_ICDF(14669), AOM_ICDF(15819), AOM_ICDF(17073),
        AOM_ICDF(21080), AOM_ICDF(22168), AOM_ICDF(22708), AOM_ICDF(22997),
        AOM_ICDF(23681), AOM_ICDF(24289), AOM_ICDF(25137), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11639), AOM_ICDF(11962), AOM_ICDF(14166), AOM_ICDF(15041),
        AOM_ICDF(16391), AOM_ICDF(23238), AOM_ICDF(23469), AOM_ICDF(23764),
        AOM_ICDF(24119), AOM_ICDF(24555), AOM_ICDF(24577), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14211), AOM_ICDF(14268), AOM_ICDF(15453), AOM_ICDF(18311),
        AOM_ICDF(19453), AOM_ICDF(19706), AOM_ICDF(21200), AOM_ICDF(21381),
        AOM_ICDF(22781), AOM_ICDF(23515), AOM_ICDF(23861), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13550), AOM_ICDF(13641), AOM_ICDF(14834), AOM_ICDF(18726),
        AOM_ICDF(18959), AOM_ICDF(19145), AOM_ICDF(19459), AOM_ICDF(21027),
        AOM_ICDF(21280), AOM_ICDF(23751), AOM_ICDF(24212), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12819), AOM_ICDF(13229), AOM_ICDF(15332), AOM_ICDF(17271),
        AOM_ICDF(17590), AOM_ICDF(18219), AOM_ICDF(18728), AOM_ICDF(20460),
        AOM_ICDF(21967), AOM_ICDF(22808), AOM_ICDF(23848), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15963), AOM_ICDF(16158), AOM_ICDF(17745), AOM_ICDF(18623),
        AOM_ICDF(19096), AOM_ICDF(19148), AOM_ICDF(19462), AOM_ICDF(19858),
        AOM_ICDF(20170), AOM_ICDF(21280), AOM_ICDF(24494), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14518), AOM_ICDF(15140), AOM_ICDF(18857), AOM_ICDF(20243),
        AOM_ICDF(20393), AOM_ICDF(20802), AOM_ICDF(20930), AOM_ICDF(21274),
        AOM_ICDF(21484), AOM_ICDF(22076), AOM_ICDF(23677), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(6542), AOM_ICDF(11600), AOM_ICDF(17060), AOM_ICDF(19819),
  AOM_ICDF(22435), AOM_ICDF(25268), AOM_ICDF(26640), AOM_ICDF(27983),
  AOM_ICDF(28779), AOM_ICDF(29528), AOM_ICDF(29944), AOM_ICDF(30803),
  AOM_ICDF(31649), AOM_ICDF(32166), AOM_ICDF(32614), AOM_ICDF(32768),
};

static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(4161), AOM_ICDF(8357), AOM_ICDF(12130), AOM_ICDF(14853),
  AOM_ICDF(16590), AOM_ICDF(18942), AOM_ICDF(20119), AOM_ICDF(22001),
  AOM_ICDF(23354), AOM_ICDF(25375), AOM_ICDF(26292), AOM_ICDF(28255),
  AOM_ICDF(28959), AOM_ICDF(30155), AOM_ICDF(31639), AOM_ICDF(32768),
};
#endif
