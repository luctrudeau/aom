...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  ...
  AOM_ICDF(8670),  AOM_ICDF(12570), AOM_ICDF(16317), AOM_ICDF(20065),
  AOM_ICDF(23101), AOM_ICDF(24661), AOM_ICDF(26151), AOM_ICDF(27523),
  AOM_ICDF(28565), AOM_ICDF(29576), AOM_ICDF(30555), AOM_ICDF(31430),
  AOM_ICDF(31990), AOM_ICDF(32401), AOM_ICDF(32768)
};
#endif
