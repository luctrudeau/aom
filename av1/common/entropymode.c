...
#if CONFIG_CFL
// Based on the average probabilities of QPs 20, 32, 43, 55 on Subset3 (1st
// Iteration)
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(719), AOM_ICDF(1061), AOM_ICDF(1216), AOM_ICDF(1539),
        AOM_ICDF(1650), AOM_ICDF(1895), AOM_ICDF(2212), AOM_ICDF(2630),
        AOM_ICDF(2862), AOM_ICDF(6160), AOM_ICDF(6992), AOM_ICDF(32768), 0 },
      { AOM_ICDF(437), AOM_ICDF(2890), AOM_ICDF(5622), AOM_ICDF(6106),
        AOM_ICDF(6231), AOM_ICDF(6911), AOM_ICDF(7106), AOM_ICDF(7381),
        AOM_ICDF(8000), AOM_ICDF(11661), AOM_ICDF(13505), AOM_ICDF(32768), 0 },
      { AOM_ICDF(461), AOM_ICDF(597), AOM_ICDF(1782), AOM_ICDF(3907),
        AOM_ICDF(4007), AOM_ICDF(4148), AOM_ICDF(4784), AOM_ICDF(5793),
        AOM_ICDF(5934), AOM_ICDF(9707), AOM_ICDF(11702), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4554), AOM_ICDF(4915), AOM_ICDF(5854), AOM_ICDF(8395),
        AOM_ICDF(8549), AOM_ICDF(8875), AOM_ICDF(9669), AOM_ICDF(10505),
        AOM_ICDF(11076), AOM_ICDF(13741), AOM_ICDF(14340), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3522), AOM_ICDF(3862), AOM_ICDF(4351), AOM_ICDF(5161),
        AOM_ICDF(7223), AOM_ICDF(8256), AOM_ICDF(9149), AOM_ICDF(9532),
        AOM_ICDF(10055), AOM_ICDF(13552), AOM_ICDF(14284), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4420), AOM_ICDF(5065), AOM_ICDF(6532), AOM_ICDF(7262),
        AOM_ICDF(8122), AOM_ICDF(12728), AOM_ICDF(13042), AOM_ICDF(13376),
        AOM_ICDF(13748), AOM_ICDF(16370), AOM_ICDF(16746), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3450), AOM_ICDF(3650), AOM_ICDF(4077), AOM_ICDF(5932),
        AOM_ICDF(6474), AOM_ICDF(6785), AOM_ICDF(9082), AOM_ICDF(9475),
        AOM_ICDF(10493), AOM_ICDF(13743), AOM_ICDF(14328), AOM_ICDF(32768), 0 },
      { AOM_ICDF(2482), AOM_ICDF(2696), AOM_ICDF(3079), AOM_ICDF(5240),
        AOM_ICDF(5386), AOM_ICDF(5599), AOM_ICDF(5966), AOM_ICDF(8100),
        AOM_ICDF(8384), AOM_ICDF(12007), AOM_ICDF(12818), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3147), AOM_ICDF(3818), AOM_ICDF(5022), AOM_ICDF(6390),
        AOM_ICDF(6592), AOM_ICDF(7073), AOM_ICDF(7515), AOM_ICDF(8760),
        AOM_ICDF(10565), AOM_ICDF(13548), AOM_ICDF(14405), AOM_ICDF(32768), 0 },
      { AOM_ICDF(877), AOM_ICDF(1277), AOM_ICDF(1607), AOM_ICDF(2057),
        AOM_ICDF(2227), AOM_ICDF(2521), AOM_ICDF(2930), AOM_ICDF(3450),
        AOM_ICDF(3768), AOM_ICDF(8252), AOM_ICDF(9317), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3367), AOM_ICDF(4215), AOM_ICDF(5592), AOM_ICDF(6488),
        AOM_ICDF(6596), AOM_ICDF(6936), AOM_ICDF(7199), AOM_ICDF(7737),
        AOM_ICDF(8044), AOM_ICDF(11314), AOM_ICDF(13730), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(4788),  AOM_ICDF(9451),  AOM_ICDF(13759), AOM_ICDF(17098),
  AOM_ICDF(20253), AOM_ICDF(23406), AOM_ICDF(25428), AOM_ICDF(27317),
  AOM_ICDF(28669), AOM_ICDF(29742), AOM_ICDF(30416), AOM_ICDF(31044),
  AOM_ICDF(31632), AOM_ICDF(32088), AOM_ICDF(32507), AOM_ICDF(32768)
};

static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(3386),  AOM_ICDF(6699),  AOM_ICDF(9766),  AOM_ICDF(12762),
  AOM_ICDF(15311), AOM_ICDF(17605), AOM_ICDF(19676), AOM_ICDF(21514),
  AOM_ICDF(23313), AOM_ICDF(25050), AOM_ICDF(26679), AOM_ICDF(28181),
  AOM_ICDF(29665), AOM_ICDF(30885), AOM_ICDF(32020), AOM_ICDF(32768)
};
#endif
