...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(24364), AOM_ICDF(24515), AOM_ICDF(25447), AOM_ICDF(25943),
        AOM_ICDF(26102), AOM_ICDF(26280), AOM_ICDF(26460), AOM_ICDF(26686),
        AOM_ICDF(26851), AOM_ICDF(27489), AOM_ICDF(27898), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7877), AOM_ICDF(11603), AOM_ICDF(17545), AOM_ICDF(18223),
        AOM_ICDF(18416), AOM_ICDF(19572), AOM_ICDF(19662), AOM_ICDF(19795),
        AOM_ICDF(20210), AOM_ICDF(20907), AOM_ICDF(24943), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9931), AOM_ICDF(9994), AOM_ICDF(15967), AOM_ICDF(20273),
        AOM_ICDF(20418), AOM_ICDF(20500), AOM_ICDF(20867), AOM_ICDF(21365),
        AOM_ICDF(21442), AOM_ICDF(23125), AOM_ICDF(24877), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15543), AOM_ICDF(15725), AOM_ICDF(16748), AOM_ICDF(20761),
        AOM_ICDF(20960), AOM_ICDF(21257), AOM_ICDF(21893), AOM_ICDF(22809),
        AOM_ICDF(23401), AOM_ICDF(24691), AOM_ICDF(25162), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15763), AOM_ICDF(15865), AOM_ICDF(16745), AOM_ICDF(17521),
        AOM_ICDF(22838), AOM_ICDF(23916), AOM_ICDF(24644), AOM_ICDF(24892),
        AOM_ICDF(25356), AOM_ICDF(26038), AOM_ICDF(26678), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12546), AOM_ICDF(12996), AOM_ICDF(14503), AOM_ICDF(15110),
        AOM_ICDF(16465), AOM_ICDF(24095), AOM_ICDF(24315), AOM_ICDF(24539),
        AOM_ICDF(24843), AOM_ICDF(25378), AOM_ICDF(25423), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15567), AOM_ICDF(15629), AOM_ICDF(16922), AOM_ICDF(18405),
        AOM_ICDF(19596), AOM_ICDF(19815), AOM_ICDF(22920), AOM_ICDF(23100),
        AOM_ICDF(23819), AOM_ICDF(24646), AOM_ICDF(24967), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15125), AOM_ICDF(15210), AOM_ICDF(16173), AOM_ICDF(18240),
        AOM_ICDF(18429), AOM_ICDF(18568), AOM_ICDF(18831), AOM_ICDF(21848),
        AOM_ICDF(22036), AOM_ICDF(24341), AOM_ICDF(24810), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14181), AOM_ICDF(14668), AOM_ICDF(15836), AOM_ICDF(17579),
        AOM_ICDF(17845), AOM_ICDF(18335), AOM_ICDF(18654), AOM_ICDF(19642),
        AOM_ICDF(22317), AOM_ICDF(23292), AOM_ICDF(24330), AOM_ICDF(32768), 0 },
      { AOM_ICDF(17955), AOM_ICDF(18164), AOM_ICDF(19057), AOM_ICDF(19498),
        AOM_ICDF(19845), AOM_ICDF(19954), AOM_ICDF(20220), AOM_ICDF(20557),
        AOM_ICDF(20812), AOM_ICDF(22152), AOM_ICDF(24864), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15457), AOM_ICDF(16272), AOM_ICDF(19364), AOM_ICDF(20127),
        AOM_ICDF(20273), AOM_ICDF(20578), AOM_ICDF(20711), AOM_ICDF(21002),
        AOM_ICDF(21198), AOM_ICDF(21918), AOM_ICDF(24852), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(8914), AOM_ICDF(13722), AOM_ICDF(19774), AOM_ICDF(21505),
  AOM_ICDF(23894), AOM_ICDF(26352), AOM_ICDF(27283), AOM_ICDF(28300),
  AOM_ICDF(28814), AOM_ICDF(29446), AOM_ICDF(29764), AOM_ICDF(30754),
  AOM_ICDF(31734), AOM_ICDF(32213), AOM_ICDF(32654), AOM_ICDF(32768),
};

static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(4669), AOM_ICDF(9311), AOM_ICDF(13284), AOM_ICDF(15791),
  AOM_ICDF(17212), AOM_ICDF(19455), AOM_ICDF(20333), AOM_ICDF(22301),
  AOM_ICDF(23409), AOM_ICDF(25588), AOM_ICDF(26247), AOM_ICDF(28401),
  AOM_ICDF(28869), AOM_ICDF(30019), AOM_ICDF(31519), AOM_ICDF(32768),
};
#endif
