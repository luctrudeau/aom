...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(24808), AOM_ICDF(24984), AOM_ICDF(25446), AOM_ICDF(25647),
        AOM_ICDF(25806), AOM_ICDF(25963), AOM_ICDF(26145), AOM_ICDF(26410),
        AOM_ICDF(26580), AOM_ICDF(27342), AOM_ICDF(27852), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13112), AOM_ICDF(18630), AOM_ICDF(18805), AOM_ICDF(18948),
        AOM_ICDF(19103), AOM_ICDF(19563), AOM_ICDF(19655), AOM_ICDF(19744),
        AOM_ICDF(20164), AOM_ICDF(21014), AOM_ICDF(24819), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14338), AOM_ICDF(14393), AOM_ICDF(20509), AOM_ICDF(20627),
        AOM_ICDF(20741), AOM_ICDF(20812), AOM_ICDF(21154), AOM_ICDF(21573),
        AOM_ICDF(21641), AOM_ICDF(22444), AOM_ICDF(25126), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15769), AOM_ICDF(15960), AOM_ICDF(16188), AOM_ICDF(21778),
        AOM_ICDF(21969), AOM_ICDF(22186), AOM_ICDF(22402), AOM_ICDF(23380),
        AOM_ICDF(24160), AOM_ICDF(25749), AOM_ICDF(26176), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15947), AOM_ICDF(16073), AOM_ICDF(16474), AOM_ICDF(16713),
        AOM_ICDF(24175), AOM_ICDF(25155), AOM_ICDF(26183), AOM_ICDF(26394),
        AOM_ICDF(26632), AOM_ICDF(27486), AOM_ICDF(27822), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13362), AOM_ICDF(14104), AOM_ICDF(14532), AOM_ICDF(14733),
        AOM_ICDF(16045), AOM_ICDF(24797), AOM_ICDF(25014), AOM_ICDF(25154),
        AOM_ICDF(25362), AOM_ICDF(26142), AOM_ICDF(26251), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15601), AOM_ICDF(15678), AOM_ICDF(16694), AOM_ICDF(16907),
        AOM_ICDF(17899), AOM_ICDF(18087), AOM_ICDF(24448), AOM_ICDF(24618),
        AOM_ICDF(24789), AOM_ICDF(25708), AOM_ICDF(25939), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15435), AOM_ICDF(15522), AOM_ICDF(16056), AOM_ICDF(16649),
        AOM_ICDF(16805), AOM_ICDF(16913), AOM_ICDF(17111), AOM_ICDF(22867),
        AOM_ICDF(23019), AOM_ICDF(24774), AOM_ICDF(25129), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14669), AOM_ICDF(15140), AOM_ICDF(15321), AOM_ICDF(16182),
        AOM_ICDF(16382), AOM_ICDF(16660), AOM_ICDF(16815), AOM_ICDF(17172),
        AOM_ICDF(22535), AOM_ICDF(23868), AOM_ICDF(24680), AOM_ICDF(32768), 0 },
      { AOM_ICDF(18981), AOM_ICDF(19198), AOM_ICDF(19611), AOM_ICDF(19824),
        AOM_ICDF(20064), AOM_ICDF(20263), AOM_ICDF(20529), AOM_ICDF(20886),
        AOM_ICDF(21130), AOM_ICDF(22986), AOM_ICDF(24596), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14212), AOM_ICDF(15115), AOM_ICDF(16626), AOM_ICDF(16811),
        AOM_ICDF(16952), AOM_ICDF(17120), AOM_ICDF(17259), AOM_ICDF(17490),
        AOM_ICDF(17668), AOM_ICDF(18538), AOM_ICDF(25750), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(16359), AOM_ICDF(17023), AOM_ICDF(22492), AOM_ICDF(22723),
  AOM_ICDF(24841), AOM_ICDF(27102), AOM_ICDF(27761), AOM_ICDF(28111),
  AOM_ICDF(28474), AOM_ICDF(29515), AOM_ICDF(29734), AOM_ICDF(30829),
  AOM_ICDF(31937), AOM_ICDF(32304), AOM_ICDF(32670), AOM_ICDF(32768),
};

static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(6634), AOM_ICDF(10724), AOM_ICDF(14773), AOM_ICDF(16539),
  AOM_ICDF(17768), AOM_ICDF(19696), AOM_ICDF(20431), AOM_ICDF(22660),
  AOM_ICDF(23596), AOM_ICDF(26090), AOM_ICDF(26624), AOM_ICDF(28736),
  AOM_ICDF(29154), AOM_ICDF(30354), AOM_ICDF(31604), AOM_ICDF(32768),
};
#endif
