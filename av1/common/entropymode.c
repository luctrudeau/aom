...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(24835), AOM_ICDF(25010), AOM_ICDF(25503), AOM_ICDF(25716),
        AOM_ICDF(25876), AOM_ICDF(26034), AOM_ICDF(26213), AOM_ICDF(26471),
        AOM_ICDF(26636), AOM_ICDF(27386), AOM_ICDF(27877), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12826), AOM_ICDF(18208), AOM_ICDF(18521), AOM_ICDF(18690),
        AOM_ICDF(18845), AOM_ICDF(19358), AOM_ICDF(19444), AOM_ICDF(19528),
        AOM_ICDF(19944), AOM_ICDF(20772), AOM_ICDF(24838), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14238), AOM_ICDF(14292), AOM_ICDF(20502), AOM_ICDF(20678),
        AOM_ICDF(20793), AOM_ICDF(20863), AOM_ICDF(21207), AOM_ICDF(21629),
        AOM_ICDF(21693), AOM_ICDF(22594), AOM_ICDF(25163), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15883), AOM_ICDF(16076), AOM_ICDF(16386), AOM_ICDF(21784),
        AOM_ICDF(21978), AOM_ICDF(22206), AOM_ICDF(22461), AOM_ICDF(23411),
        AOM_ICDF(24174), AOM_ICDF(25708), AOM_ICDF(26133), AOM_ICDF(32768), 0 },
      { AOM_ICDF(16051), AOM_ICDF(16169), AOM_ICDF(16627), AOM_ICDF(16911),
        AOM_ICDF(24126), AOM_ICDF(25123), AOM_ICDF(26120), AOM_ICDF(26332),
        AOM_ICDF(26588), AOM_ICDF(27406), AOM_ICDF(27773), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13322), AOM_ICDF(14024), AOM_ICDF(14580), AOM_ICDF(14827),
        AOM_ICDF(16149), AOM_ICDF(24789), AOM_ICDF(25005), AOM_ICDF(25152),
        AOM_ICDF(25372), AOM_ICDF(26107), AOM_ICDF(26201), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15767), AOM_ICDF(15842), AOM_ICDF(16912), AOM_ICDF(17210),
        AOM_ICDF(18235), AOM_ICDF(18424), AOM_ICDF(24362), AOM_ICDF(24532),
        AOM_ICDF(24737), AOM_ICDF(25646), AOM_ICDF(25892), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15530), AOM_ICDF(15613), AOM_ICDF(16190), AOM_ICDF(16874),
        AOM_ICDF(17032), AOM_ICDF(17142), AOM_ICDF(17343), AOM_ICDF(22788),
        AOM_ICDF(22938), AOM_ICDF(24769), AOM_ICDF(25141), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14768), AOM_ICDF(15249), AOM_ICDF(15504), AOM_ICDF(16477),
        AOM_ICDF(16684), AOM_ICDF(16984), AOM_ICDF(17151), AOM_ICDF(17546),
        AOM_ICDF(22555), AOM_ICDF(23820), AOM_ICDF(24685), AOM_ICDF(32768), 0 },
      { AOM_ICDF(18933), AOM_ICDF(19152), AOM_ICDF(19596), AOM_ICDF(19819),
        AOM_ICDF(20069), AOM_ICDF(20260), AOM_ICDF(20523), AOM_ICDF(20869),
        AOM_ICDF(21109), AOM_ICDF(22880), AOM_ICDF(24652), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14633), AOM_ICDF(15553), AOM_ICDF(17265), AOM_ICDF(17487),
        AOM_ICDF(17628), AOM_ICDF(17810), AOM_ICDF(17948), AOM_ICDF(18183),
        AOM_ICDF(18361), AOM_ICDF(19218), AOM_ICDF(25707), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(15598), AOM_ICDF(16719), AOM_ICDF(22384), AOM_ICDF(22697),
  AOM_ICDF(24884), AOM_ICDF(27108), AOM_ICDF(27766), AOM_ICDF(28257),
  AOM_ICDF(28625), AOM_ICDF(29478), AOM_ICDF(29726), AOM_ICDF(30822),
  AOM_ICDF(31914), AOM_ICDF(32290), AOM_ICDF(32670), AOM_ICDF(32768),
};

static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(6105), AOM_ICDF(10539), AOM_ICDF(14557), AOM_ICDF(16537),
  AOM_ICDF(17740), AOM_ICDF(19726), AOM_ICDF(20455), AOM_ICDF(22647),
  AOM_ICDF(23582), AOM_ICDF(26012), AOM_ICDF(26544), AOM_ICDF(28706),
  AOM_ICDF(29112), AOM_ICDF(30294), AOM_ICDF(31577), AOM_ICDF(32768),
};
#endif
